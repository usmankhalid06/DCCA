...
%     L = legend(OH, 'Sub1','Sub2', 'Sub3','Sub4', 'Sub5','Sub6', 'Sub7','Sub8'); 
%     set(L, 'units', 'normalized','FontSize', 14 ,'Color', bg, 'EdgeColor', bg);
%     LPos = get(L, 'Position');     % [left bottom width height]
%     set(L, 'Position', [axPos(1)+axPos(3), .17-LPos(4)/2, LPos(3)-0.075, LPos(4)])

%     %% my code
    L = legend(OH, 'Src1','Src2', 'Src3','Src4', 'Src5','Src6', 'Src7','Src8','Src9','Src10','Src11','Src12'); 
    set(L, 'units', 'normalized','FontSize', 14 ,'Color', bg, 'EdgeColor', bg);
    LPos = get(L, 'Position');     % [left bottom width height]
    set(L, 'Position', [axPos(1)+axPos(3), -.4+LPos(4)/2, LPos(3)-0.090, LPos(4)]) 

    %% my code
%     L = legend(OH, 'Sub1','Sub2', 'Sub3','Sub4', 'Sub5','Sub6', 'Sub7','Sub8'); 
%     set(L, 'units', 'normalized','FontSize', 14 ,'Color', bg, 'EdgeColor', bg);
%     LPos = get(L, 'Position');     % [left bottom width height]
%     set(L, 'Position', [axPos(1)+axPos(3), -.18+LPos(4)/2, LPos(3)-0.080, LPos(4)])   
